...
class CentroidTracker():
    def __init__(self, maxDisappeared=5, maxDistance = 50, boundary= 300):
    ...
    def update(self, circles):
        ...
        if len(circles) == 0:
            ...
            # to update
            return self.objects,self.objectRadius
        ...
        if len(self.objects) == 0:
            for i in range(0, len(inputCentroids)):
                self.register(inputCentroids[i], inputRadius[i])
        ...
        # centroids
            ...
            for col in unusedCols:
                ...
                if self.overlap((inputCentroids[col],inputRadius[col])):
                    continue
                self.register(inputCentroids[col],inputRadius[col])
